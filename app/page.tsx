...
export default function Home() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${
          stateBgMap[weatherData.weather[0].main] || "/default.jpg"
        })`,
      ...
      <div className="flex flex-col items-start w-full max-w-[1500px] px-4 py-6 mx-auto gap-5">
        <div className="w-full flex items-center gap-2 justify-between">
          <div className="flex flex-col items-start">
            ...
            <div className="flex items-center justify-center gap-2 bg-slate-100
             to-blue-100 text-black px-5 py-1 w-full rounded-lg text-center">
